...
const ui_es = {
  ...
  keywordPlaceholder: 'Ej: piscina, condominio...',
  rooms: 'Cuartos',
  minBeds: 'Cuartos mín.',
  minBaths: 'Baños mín.',
  minBuiltLabel: 'm² Const. (mín.)',
  minLotLabel: 'm² Terreno (mín.)',
  minBuiltMobile: 'm² Const. mín.',
  minLotMobile: 'm² Terreno mín.',
  ...
  // Nav — property type chips
  ptAll: 'Todas',
  ptHouse: 'Casa / Villa',
  ptApt: 'Apto / Condo',
  ptLand: 'Lote / Terreno',
  ptMultifamily: 'Multifamiliar',
...
const ui_en: typeof ui_es = {
  ...
  filters: 'Filters',
  keyword: 'Keyword',
  keywordPlaceholder: 'E.g.: pool, condo...',
  rooms: 'Rooms',
  minBeds: 'Min. rooms',
  minBaths: 'Min. baths',
  minBuiltLabel: 'Min. built (m²)',
  minLotLabel: 'Min. lot (m²)',
  minBuiltMobile: 'Min. built (m²)',
  minLotMobile: 'Min. lot (m²)',
